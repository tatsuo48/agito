...
- "commit_subject": imperative mood, max 72 chars. Must be in English.
- "commit_body": markdown explaining what changed and why. Must be in English. 2-5 sentences.
- "pr_title": similar to commit_subject but can include conventional commit prefix. Must be in English.
- "pr_body": markdown with sections "## Context", "## Changes", "## How to verify". Must be in English.
...
- Never output Japanese, Chinese, Korean, or any non-English text, even if the diff contains such text.
%s
<diff>
%s
